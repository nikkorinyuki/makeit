...
export async function generateImage(query: query) {
    ...
    const name = calc_best_size(query.name, maxTextWidth, canvasHeight, 20, { fonts: ["name", "NotoSansJP-Medium", "NotoSansKR-Medium", "NotoSansSC-Medium"], italic: true, color: query.tcolor ?? "#000" }, query.markdown, 20);
